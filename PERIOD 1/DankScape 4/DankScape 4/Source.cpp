...
void main() {
	...
	if (answer == 1) {
		...
		if (answer == 1) {
			...
			outtextxy(100, 250, ayylamao.c_str());
			outtextxy(100, 350, ayylamao2.c_str());
			cin >> answer;
			...
			if (answer == 1) {
				...
				if (answer == 1) {
					...
					bar(0, 0, 1920, 1080);
					setfillstyle(1, 3);
					outtextxy(750, 540, twat.c_str());
					playSound("SadViolin.mp3", 21000);
					cleardevice();
					for (int i = 0; i < 25; i++) {
						setfillstyle(1, 14);
						bar(0, 0, 1920, 1080);
					...
					outtextxy(100, 150, answer4.c_str()); /*oh shit waddup*/
					outtextxy(100, 250, answer5.c_str()); /*fight dat boi*/
