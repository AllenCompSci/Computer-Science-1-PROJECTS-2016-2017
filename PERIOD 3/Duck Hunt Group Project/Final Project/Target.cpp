...
#pragma region example
	...
	colors.at(0).init(172, 124, 3, 4);
	colors.at(1).init(0, 0, 0, 0);
	colors.at(2).init(43, 72, 218, 99);
	colors.at(3).init(228, 92, 16, 6);
	colors.at(4).init(3, 3, 3, 8);
	colors.at(5).init(136, 20, 3, 4);
...
#pragma endregion
	...
	ReadBMP(TEXT("MouseCursor")); // 24 bit depth .bmp
								 /*
